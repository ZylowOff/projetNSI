...
def afficher_menu():
    while True:
        ...
        # Boutons - Ajustés pour être plus bas et mieux espacés
        hauteur_base = HAUTEUR // 2  # Point de départ des boutons
        espacement = 100  # Espacement entre les boutons
...
def afficher_menu_pause():
    while True:
        ...
        for bouton, texte in boutons:
            if bouton.collidepoint(souris_x, souris_y):
                couleur = (255, 0, 0)  # Rouge pour le survol
                bouton = bouton.inflate(20, 20)
            else:
                couleur = BORDEAUX
