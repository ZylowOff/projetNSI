...
def afficher_parametres():
    ...
    while True:
        ...
        draw_button(fenetre, bouton_retour, "Retour", pygame.font.Font(font_helpme, 30), violet_hover, violet, blanc, icon_text="B", icon_font=pygame.font.Font("./Arrows.ttf", 30))

        bouton_sauvegarde = pygame.Rect(center_x - 150, hauteur - 150, 300, 60)
        draw_button(fenetre, bouton_sauvegarde, "Sauvegarder", pygame.font.Font(font_helpme, 30), violet_hover, violet, blanc)
...
def load_settings():
    global resolution_index, largeur, hauteur, is_fullscreen, montrer_fps, volume, controles
    ...
    try:
        with open(fichier_parametres, "r") as file:
            ...
            largeur, hauteur = resolutions[resolution_index]
            is_fullscreen = settings.get("plein_ecran", parametres_par_defaut["plein_ecran"])
...
def afficher_menu():
    ...
    while True:
        ...
        for bouton, texte in boutons:
            draw_button(fenetre, bouton, texte, font, violet_hover, violet, blanc)
